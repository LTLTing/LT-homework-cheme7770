...
################################
	...
	-	the setting were almost the same as that of aerobic condition. The only different thing is that at anaerobic case, the oxygen uptake rate were set to be zero.
